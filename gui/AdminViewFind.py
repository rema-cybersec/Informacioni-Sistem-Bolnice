...
class AdminViewFind(ctk.CTkToplevel):
    WINDOW_WIDTH = 400
    WINDOW_HEIGHT = 400
    ...
    def __init__(self, master):
        ...
        self.title_label = ctk.CTkLabel(self, font=ctk.CTkFont(size=20, weight="bold"), text="Find Records")
        ...
        self.key_entry = ctk.CTkEntry(self, placeholder_text="username", show="#")
